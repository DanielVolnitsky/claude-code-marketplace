...
- **Be concise**. Respect human-in-the-loop time necessary to review the produced spec. Be brief. Avoid duplication;  
- **Writing style**. Use **ASD-STE100** Simplified Technical English standard when writing the design/spec file.
...
- Use `AskUserQuestion` tool to propose human next steps options:
